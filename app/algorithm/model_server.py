...
class ModelServer:
    ...
    def explain_local(self, data): 
        ...
        for i in range(N):
            ...
            sample_expl_dict['predicted_class'] = class_names[pred_class_probs[i].argmax()]
            ...
            for j, c in enumerate(class_names):                 
                ...
                feature_impacts = {
                    f:np.round(v,4) for f,v in zip(features, shap_values.values[i, :, j])
                }
